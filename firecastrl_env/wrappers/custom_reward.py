...
def default_reward_function(env: gym.Env, prev_state: dict[str, Any], curr_state: dict[str, Any]) -> float:
    """
...
class CustomRewardWrapper(RewardWrapper):
    ...
    def __init__(
        self, env: gym.Env, reward_fn: Optional[Callable[[gym.Env, dict[str, Any], dict[str, Any]], float]] = None
    ):
        super().__init__(env)
